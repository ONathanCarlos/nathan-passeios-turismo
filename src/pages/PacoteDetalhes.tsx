...
const PacoteDetalhes = () => {
  ...
  const imgs = pacote.tour_keys.map(imgOf).filter(Boolean);
        ...
        <section className="glass-card rounded-3xl overflow-hidden border-amber-400/30">
          ...
          <div className="p-5">
            ...
            <div className="flex items-end justify-between gap-3 flex-wrap">
              <p className="text-3xl sm:text-4xl font-extrabold bg-gradient-to-r from-amber-300 to-turquoise-glow bg-clip-text text-transparent">
        ...
        <div className="mt-10">
          ...
          >
            <span className="flex items-center justify-center gap-2 rounded-[0.7rem] bg-gradient-to-r from-deep-blue to-night px-6 py-4 text-base font-bold text-foreground">
              ✨ {L.book[lang]} — {formatBRL(pacote.preco)}
            </span>
          </button>
        </div>
